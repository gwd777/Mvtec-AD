...
class Preprocessing(torch.nn.Module):
    ...
    def forward(self, features):
        ...
        for module, feature in zip(self.preprocessing_modules, features):
            ...
            _features.append(module_feature)
        stack_ft = torch.stack(_features, dim=1)    # oi = fcat(resize(zl′_i, (H0, W0))|l′ ∈ L (3)
        return stack_ft
...
class MeanMapper(torch.nn.Module):
    ...
    def forward(self, features):
        ...
        return F.adaptive_avg_pool1d(features, self.preprocessing_dim).squeeze(1)   # Aggregating the features within the neighborhood. agg func as adaptive_avg_pool1d
