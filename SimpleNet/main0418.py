...
_DATASETS = {
    "mvtec": ["datasets.mvtec_ls", "MVTecDataset"],
...
def run(
    ...
    list_of_dataloaders = get_dataloaders(name="mvtec", data_path='D:\mvtec_anomaly_detection', subdatasets=['screw'], resize=128, batch_size=16)
    # list_of_dataloaders = get_dataloaders(name="mvtec", data_path='D:\mvtec_anomaly_detection', subdatasets=['screw'], resize=64, ignore_mask=True)
    ...
    for dataloader_count, dataloaders in enumerate(list_of_dataloaders):
        ...
        simplenet_list = get_simplenet(input_shape=imagesize, device=device, meta_epochs=4)
