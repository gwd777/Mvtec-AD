...
def run(
    ...
    # list_of_dataloaders = get_dataloaders(name="hwhq", data_path='D:\mvtec_anomaly_detection\hw_hq_data', subdatasets=['hw_hq_data'], resize=128)
    list_of_dataloaders = get_dataloaders(name="mvtec", data_path='D:\mvtec_anomaly_detection', subdatasets=['hw_ls_data'])
