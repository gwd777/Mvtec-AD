...
def run(
    ...
    list_of_dataloaders = get_dataloaders(name="mvtec", data_path='D:\mvtec_anomaly_detection', subdatasets=['screw', 'pill'], resize=64)

    # list_of_dataloaders = get_dataloaders(name="mvtec", data_path='D:\mvtec_anomaly_detection', subdatasets=['hw_hq_data', 'hw_ls_data'])
    ...
    for dataloader_count, dataloaders in enumerate(list_of_dataloaders):
        ...
        simplenet_list = get_simplenet(input_shape=imagesize, device=device, meta_epochs=2)
...
def get_dataloaders(
    ...
    for subdataset in subdatasets:
        ...
        LOGGER.info(f"_________>Dataset: train={len(train_dataset)} test={len(test_dataset)}")
