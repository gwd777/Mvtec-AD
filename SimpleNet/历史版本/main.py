...
--resize 329 ^
--imagesize 288 ^
-d screw -d pill -d capsule -d carpet -d grid -d tile -d wood -d zipper -d cable -d toothbrush -d transistor -d metal_nut -d bottle -d hazelnut -d leather ^
mvtec D:\mvtec_anomaly_detection
...
def run(
    ...
    methods = {
        key: item for (key, item) in methods
    }

    print('____test_____>', test)
...
def net(
    ...
    print('_________backbone_names__________>', backbone_names)
...
def dataset(
    ...
    print('_________subdatasets________>', subdatasets)
